...
(cl:defmethod cl:initialize-instance :after ((m <GetErrorID-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetErrorID-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v4-srv:<GetErrorID-request> is deprecated: use rosdemo_v4-srv:GetErrorID-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetErrorID-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetErrorID-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v4-srv:<GetErrorID-response> is deprecated: use rosdemo_v4-srv:GetErrorID-response instead.")))

(cl:ensure-generic-function 'error_id-val :lambda-list '(m))
(cl:defmethod error_id-val ((m <GetErrorID-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v4-srv:error_id-val is deprecated.  Use rosdemo_v4-srv:error_id instead.")
  (error_id m))
