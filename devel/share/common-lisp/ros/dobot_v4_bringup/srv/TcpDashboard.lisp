...
(cl:defmethod cl:initialize-instance :after ((m <TcpDashboard-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TcpDashboard-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<TcpDashboard-request> is deprecated: use dobot_v4_bringup-srv:TcpDashboard-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <TcpDashboard-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_v4_bringup-srv:command-val is deprecated.  Use dobot_v4_bringup-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TcpDashboard-request>)))
  ...
  "dobot_v4_bringup/TcpDashboardRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TcpDashboard-request)))
  "Returns string type for a service object of type 'TcpDashboard-request"
  "dobot_v4_bringup/TcpDashboardRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TcpDashboard-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TcpDashboard-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<TcpDashboard-response> is deprecated: use dobot_v4_bringup-srv:TcpDashboard-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <TcpDashboard-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_v4_bringup-srv:result-val is deprecated.  Use dobot_v4_bringup-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TcpDashboard-response>)))
  ...
  "dobot_v4_bringup/TcpDashboardResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TcpDashboard-response)))
  "Returns string type for a service object of type 'TcpDashboard-response"
  "dobot_v4_bringup/TcpDashboardResponse")
