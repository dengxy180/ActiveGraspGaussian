...
(cl:defmethod cl:initialize-instance :after ((m <DO-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DO-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<DO-request> is deprecated: use dobot_v4_bringup-srv:DO-request instead.")))
...
(cl:defmethod time-val ((m <DO-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_v4_bringup-srv:time-val is deprecated.  Use dobot_v4_bringup-srv:time instead.")
  (time m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DO-request>)))
  ...
  (cl:format cl:nil "int32 index~%int32 status~%int32 time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DO-request)))
  "Returns full string definition for message of type 'DO-request"
  (cl:format cl:nil "int32 index~%int32 status~%int32 time~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <DO-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DO-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<DO-response> is deprecated: use dobot_v4_bringup-srv:DO-response instead.")))
