...
(cl:defmethod cl:initialize-instance :after ((m <RelJointMovJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RelJointMovJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<RelJointMovJ-request> is deprecated: use dobot_v4_bringup-srv:RelJointMovJ-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <RelJointMovJ-request>))
...
(cl:defmethod b-val ((m <RelJointMovJ-request>))
...
(cl:defmethod c-val ((m <RelJointMovJ-request>))
...
(cl:defmethod d-val ((m <RelJointMovJ-request>))
...
(cl:defmethod e-val ((m <RelJointMovJ-request>))
...
(cl:defmethod f-val ((m <RelJointMovJ-request>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RelJointMovJ-request>)))
  ...
  "dobot_v4_bringup/RelJointMovJRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RelJointMovJ-request)))
  "Returns string type for a service object of type 'RelJointMovJ-request"
  "dobot_v4_bringup/RelJointMovJRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RelJointMovJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RelJointMovJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<RelJointMovJ-response> is deprecated: use dobot_v4_bringup-srv:RelJointMovJ-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RelJointMovJ-response>)))
  ...
  "dobot_v4_bringup/RelJointMovJResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RelJointMovJ-response)))
  "Returns string type for a service object of type 'RelJointMovJ-response"
  "dobot_v4_bringup/RelJointMovJResponse")
