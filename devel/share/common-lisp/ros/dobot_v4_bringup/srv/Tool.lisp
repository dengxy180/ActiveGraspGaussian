...
(cl:defmethod cl:initialize-instance :after ((m <Tool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<Tool-request> is deprecated: use dobot_v4_bringup-srv:Tool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Tool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<Tool-response> is deprecated: use dobot_v4_bringup-srv:Tool-response instead.")))
