...
(cl:defmethod cl:initialize-instance :after ((m <AI-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AI-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<AI-request> is deprecated: use dobot_v4_bringup-srv:AI-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <AI-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AI-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<AI-response> is deprecated: use dobot_v4_bringup-srv:AI-response instead.")))
