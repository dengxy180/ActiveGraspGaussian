...
(cl:defmethod cl:initialize-instance :after ((m <Stop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<Stop-request> is deprecated: use dobot_v4_bringup-srv:Stop-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Stop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<Stop-response> is deprecated: use dobot_v4_bringup-srv:Stop-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <Stop-response>))
