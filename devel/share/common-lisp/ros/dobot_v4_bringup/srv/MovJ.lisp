...
(cl:defmethod cl:initialize-instance :after ((m <MovJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<MovJ-request> is deprecated: use dobot_v4_bringup-srv:MovJ-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MovJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<MovJ-response> is deprecated: use dobot_v4_bringup-srv:MovJ-response instead.")))
