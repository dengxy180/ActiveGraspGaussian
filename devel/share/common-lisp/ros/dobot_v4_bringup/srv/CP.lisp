...
(cl:defmethod cl:initialize-instance :after ((m <CP-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CP-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<CP-request> is deprecated: use dobot_v4_bringup-srv:CP-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <CP-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CP-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<CP-response> is deprecated: use dobot_v4_bringup-srv:CP-response instead.")))
