...
(cl:defmethod cl:initialize-instance :after ((m <DI-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DI-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<DI-request> is deprecated: use dobot_v4_bringup-srv:DI-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <DI-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DI-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<DI-response> is deprecated: use dobot_v4_bringup-srv:DI-response instead.")))
