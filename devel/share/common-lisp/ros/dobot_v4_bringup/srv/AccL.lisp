...
(cl:defmethod cl:initialize-instance :after ((m <AccL-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccL-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<AccL-request> is deprecated: use dobot_v4_bringup-srv:AccL-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <AccL-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccL-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<AccL-response> is deprecated: use dobot_v4_bringup-srv:AccL-response instead.")))
