...
(cl:defmethod cl:initialize-instance :after ((m <RelMovJUser-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RelMovJUser-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<RelMovJUser-request> is deprecated: use dobot_v4_bringup-srv:RelMovJUser-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <RelMovJUser-request>))
...
(cl:defmethod b-val ((m <RelMovJUser-request>))
...
(cl:defmethod c-val ((m <RelMovJUser-request>))
...
(cl:defmethod d-val ((m <RelMovJUser-request>))
...
(cl:defmethod e-val ((m <RelMovJUser-request>))
...
(cl:defmethod f-val ((m <RelMovJUser-request>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RelMovJUser-request>)))
  ...
  "dobot_v4_bringup/RelMovJUserRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RelMovJUser-request)))
  "Returns string type for a service object of type 'RelMovJUser-request"
  "dobot_v4_bringup/RelMovJUserRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RelMovJUser-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RelMovJUser-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<RelMovJUser-response> is deprecated: use dobot_v4_bringup-srv:RelMovJUser-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RelMovJUser-response>)))
  ...
  "dobot_v4_bringup/RelMovJUserResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RelMovJUser-response)))
  "Returns string type for a service object of type 'RelMovJUser-response"
  "dobot_v4_bringup/RelMovJUserResponse")
