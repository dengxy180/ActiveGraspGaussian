...
(cl:defmethod cl:initialize-instance :after ((m <User-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'User-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<User-request> is deprecated: use dobot_v4_bringup-srv:User-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <User-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'User-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<User-response> is deprecated: use dobot_v4_bringup-srv:User-response instead.")))
