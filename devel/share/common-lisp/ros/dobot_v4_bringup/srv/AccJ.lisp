...
(cl:defmethod cl:initialize-instance :after ((m <AccJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<AccJ-request> is deprecated: use dobot_v4_bringup-srv:AccJ-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <AccJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-srv:<AccJ-response> is deprecated: use dobot_v4_bringup-srv:AccJ-response instead.")))
