...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_v4_bringup-msg:<RobotStatus> is deprecated: use dobot_v4_bringup-msg:RobotStatus instead.")))

(cl:ensure-generic-function 'is_enable-val :lambda-list '(m))
(cl:defmethod is_enable-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_v4_bringup-msg:is_enable-val is deprecated.  Use dobot_v4_bringup-msg:is_enable instead.")
  (is_enable m))

(cl:ensure-generic-function 'is_connected-val :lambda-list '(m))
(cl:defmethod is_connected-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_v4_bringup-msg:is_connected-val is deprecated.  Use dobot_v4_bringup-msg:is_connected instead.")
  (is_connected m))
