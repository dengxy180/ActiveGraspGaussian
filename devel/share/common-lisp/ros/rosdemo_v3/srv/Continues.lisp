...
(cl:defmethod cl:initialize-instance :after ((m <Continues-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Continues-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<Continues-request> is deprecated: use rosdemo_v3-srv:Continues-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Continues-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Continues-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<Continues-response> is deprecated: use rosdemo_v3-srv:Continues-response instead.")))
