...
(cl:defmethod cl:initialize-instance :after ((m <JointMovJ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointMovJ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<JointMovJ-request> is deprecated: use rosdemo_v3-srv:JointMovJ-request instead.")))

(cl:ensure-generic-function 'j1-val :lambda-list '(m))
(cl:defmethod j1-val ((m <JointMovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:j1-val is deprecated.  Use rosdemo_v3-srv:j1 instead.")
  (j1 m))

(cl:ensure-generic-function 'j2-val :lambda-list '(m))
(cl:defmethod j2-val ((m <JointMovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:j2-val is deprecated.  Use rosdemo_v3-srv:j2 instead.")
  (j2 m))

(cl:ensure-generic-function 'j3-val :lambda-list '(m))
(cl:defmethod j3-val ((m <JointMovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:j3-val is deprecated.  Use rosdemo_v3-srv:j3 instead.")
  (j3 m))

(cl:ensure-generic-function 'j4-val :lambda-list '(m))
(cl:defmethod j4-val ((m <JointMovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:j4-val is deprecated.  Use rosdemo_v3-srv:j4 instead.")
  (j4 m))

(cl:ensure-generic-function 'j5-val :lambda-list '(m))
(cl:defmethod j5-val ((m <JointMovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:j5-val is deprecated.  Use rosdemo_v3-srv:j5 instead.")
  (j5 m))

(cl:ensure-generic-function 'j6-val :lambda-list '(m))
(cl:defmethod j6-val ((m <JointMovJ-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:j6-val is deprecated.  Use rosdemo_v3-srv:j6 instead.")
  (j6 m))
...
(cl:defmethod cl:initialize-instance :after ((m <JointMovJ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointMovJ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<JointMovJ-response> is deprecated: use rosdemo_v3-srv:JointMovJ-response instead.")))
