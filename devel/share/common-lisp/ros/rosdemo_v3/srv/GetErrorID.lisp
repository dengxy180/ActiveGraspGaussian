...
(cl:defmethod cl:initialize-instance :after ((m <GetErrorID-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetErrorID-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<GetErrorID-request> is deprecated: use rosdemo_v3-srv:GetErrorID-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetErrorID-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetErrorID-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<GetErrorID-response> is deprecated: use rosdemo_v3-srv:GetErrorID-response instead.")))
...
(cl:defmethod errorID-val ((m <GetErrorID-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:errorID-val is deprecated.  Use rosdemo_v3-srv:errorID instead.")
  (errorID m))
