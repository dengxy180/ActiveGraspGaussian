...
(cl:defmethod cl:initialize-instance :after ((m <ClearError-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClearError-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<ClearError-request> is deprecated: use rosdemo_v3-srv:ClearError-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ClearError-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClearError-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<ClearError-response> is deprecated: use rosdemo_v3-srv:ClearError-response instead.")))
