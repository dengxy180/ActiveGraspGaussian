...
(cl:defmethod cl:initialize-instance :after ((m <EnableRobot-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnableRobot-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<EnableRobot-request> is deprecated: use rosdemo_v3-srv:EnableRobot-request instead.")))

(cl:ensure-generic-function 'args-val :lambda-list '(m))
(cl:defmethod args-val ((m <EnableRobot-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:args-val is deprecated.  Use rosdemo_v3-srv:args instead.")
  (args m))
...
(cl:defmethod cl:initialize-instance :after ((m <EnableRobot-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnableRobot-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<EnableRobot-response> is deprecated: use rosdemo_v3-srv:EnableRobot-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EnableRobot-response>)))
  ...
  "rosdemo_v3/EnableRobotResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EnableRobot-response)))
  "Returns string type for a service object of type 'EnableRobot-response"
  "rosdemo_v3/EnableRobotResponse")
