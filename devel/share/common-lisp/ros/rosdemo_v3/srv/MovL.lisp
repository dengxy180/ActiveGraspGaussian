...
(cl:defmethod cl:initialize-instance :after ((m <MovL-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovL-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<MovL-request> is deprecated: use rosdemo_v3-srv:MovL-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:x-val is deprecated.  Use rosdemo_v3-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:y-val is deprecated.  Use rosdemo_v3-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:z-val is deprecated.  Use rosdemo_v3-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:a-val is deprecated.  Use rosdemo_v3-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:b-val is deprecated.  Use rosdemo_v3-srv:b instead.")
  (b m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:c-val is deprecated.  Use rosdemo_v3-srv:c instead.")
  (c m))

(cl:ensure-generic-function 'paramValue-val :lambda-list '(m))
(cl:defmethod paramValue-val ((m <MovL-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:paramValue-val is deprecated.  Use rosdemo_v3-srv:paramValue instead.")
  (paramValue m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MovL-request>)))
  ...
  "4c865d064beeb78c6b96e5e5798d8d9f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MovL-request)))
  "Returns md5sum for a message object of type 'MovL-request"
  "4c865d064beeb78c6b96e5e5798d8d9f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MovL-request>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 a~%float64 b~%float64 c~%string[] paramValue~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MovL-request)))
  "Returns full string definition for message of type 'MovL-request"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 a~%float64 b~%float64 c~%string[] paramValue~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <MovL-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovL-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<MovL-response> is deprecated: use rosdemo_v3-srv:MovL-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <MovL-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosdemo_v3-srv:res-val is deprecated.  Use rosdemo_v3-srv:res instead.")
  (res m))
