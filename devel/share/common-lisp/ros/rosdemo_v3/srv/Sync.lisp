...
(cl:defmethod cl:initialize-instance :after ((m <Sync-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sync-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<Sync-request> is deprecated: use rosdemo_v3-srv:Sync-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Sync-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sync-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosdemo_v3-srv:<Sync-response> is deprecated: use rosdemo_v3-srv:Sync-response instead.")))
