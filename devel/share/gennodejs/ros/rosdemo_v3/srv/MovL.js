...
class MovLRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovLRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovLRequest
    let len;
    let data = new MovLRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovLRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class MovLResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovLResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovLResponse
    let len;
    let data = new MovLResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovLResponse(null);
...
module.exports = {
  Request: MovLRequest,
  Response: MovLResponse,
  md5sum() { return '4c865d064beeb78c6b96e5e5798d8d9f'; },
  datatype() { return 'rosdemo_v3/MovL'; }
};
