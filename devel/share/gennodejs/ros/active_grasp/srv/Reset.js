...
let AABBox = require('../msg/AABBox.js');
...
class ResetResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AABBox.serialize(obj.bbox, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.bbox = AABBox.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.bbox !== undefined) {
      resolved.bbox = AABBox.Resolve(msg.bbox)
    }
    else {
      resolved.bbox = new AABBox()
    }
...
module.exports = {
  ...
  md5sum() { return '4dd9de15958dc8059c48f7ba8054e4b8'; },
  datatype() { return 'active_grasp/Reset'; }
};
