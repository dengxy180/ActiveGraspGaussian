...
class MovLIORequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovLIORequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovLIORequest
    let len;
    let data = new MovLIORequest(null);
  ...
  static datatype() {
    ...
    return 'dobot_v4_bringup/MovLIORequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovLIORequest(null);
...
class MovLIOResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MovLIOResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MovLIOResponse
    let len;
    let data = new MovLIOResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dobot_v4_bringup/MovLIOResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MovLIOResponse(null);
...
module.exports = {
  Request: MovLIORequest,
  Response: MovLIOResponse,
  md5sum() { return 'b1cf53f9f44e517c793a913e7740569a'; },
  datatype() { return 'dobot_v4_bringup/MovLIO'; }
};
