...
class RelMovJToolRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RelMovJToolRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RelMovJToolRequest
    let len;
    let data = new RelMovJToolRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RelMovJToolRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class RelMovJToolResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RelMovJToolResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RelMovJToolResponse
    let len;
    let data = new RelMovJToolResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dobot_v4_bringup/RelMovJToolResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RelMovJToolResponse(null);
...
module.exports = {
  Request: RelMovJToolRequest,
  Response: RelMovJToolResponse,
  md5sum() { return 'acbcde02d4dabec81bbbb65ee94d60dc'; },
  datatype() { return 'dobot_v4_bringup/RelMovJTool'; }
};
