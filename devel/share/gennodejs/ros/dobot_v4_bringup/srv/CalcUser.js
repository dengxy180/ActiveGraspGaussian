...
class CalcUserRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CalcUserRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CalcUserRequest
    let len;
    let data = new CalcUserRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CalcUserRequest(null);
...
class CalcUserResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CalcUserResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CalcUserResponse
    let len;
    let data = new CalcUserResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dobot_v4_bringup/CalcUserResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CalcUserResponse(null);
...
module.exports = {
  Request: CalcUserRequest,
  Response: CalcUserResponse,
  md5sum() { return '2ca5e99fbfe69882ece191e51f4e52e0'; },
  datatype() { return 'dobot_v4_bringup/CalcUser'; }
};
