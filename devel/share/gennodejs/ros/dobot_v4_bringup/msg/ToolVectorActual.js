...
// (in-package dobot_v4_bringup.msg)
...
class ToolVectorActual {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ToolVectorActual(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ToolVectorActual(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = ToolVectorActual;
