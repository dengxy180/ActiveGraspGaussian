...
if("TRUE" STREQUAL "TRUE")
  set(dh_robotics_ag95_gazebo_SOURCE_PREFIX /home/dxy/catkin_active_grasp_ws/src/dh_gripper_ros/dh_robotics_ag95_gripper/dh_robotics_ag95_simulation/dh_robotics_ag95_gazebo)
  set(dh_robotics_ag95_gazebo_DEVEL_PREFIX /home/dxy/catkin_active_grasp_ws/devel)
  ...
  set(dh_robotics_ag95_gazebo_INSTALL_PREFIX /home/dxy/catkin_active_grasp_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dh_robotics_ag95_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dxy/catkin_active_grasp_ws/src/dh_gripper_ros/dh_robotics_ag95_gripper/dh_robotics_ag95_simulation/dh_robotics_ag95_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(dh_robotics_ag95_gazebo_EXPORTED_TARGETS ${${dh_robotics_ag95_gazebo_dep}_EXPORTED_TARGETS})
endforeach()
